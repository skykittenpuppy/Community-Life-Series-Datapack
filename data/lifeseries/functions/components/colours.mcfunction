execute if score 3rdlife constants matches 1.. run team join gray @a[team=!cameo,team=!gray,scores={lives=..0}]
execute if score lastlife constants matches 1.. run team join gray @a[team=!cameo,team=!gray,scores={lives=..0}]
execute if score doublelife constants matches 1.. run team join gray @a[team=!cameo,team=!gray,scores={lives=..0}]
execute if score limitedlife constants matches 1.. run team join gray @a[team=!cameo,team=!gray,scores={ticks=..0}]
