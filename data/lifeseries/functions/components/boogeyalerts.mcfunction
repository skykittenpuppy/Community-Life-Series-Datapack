...
execute if score boogeyTimer constants matches 1 if score gamemode constants matches 2 run tag @r[tag=!boogeyman,scores={lives=2..}] add boogeyman
...
execute if score boogeyTimer constants matches 1.. if score gamemode constants matches 2 run bossbar set boogeyreveal max 6000
execute if score boogeyTimer constants matches 1.. if score gamemode constants matches 4 run bossbar set boogeyreveal max 1200
...
execute if score boogeyTimer constants matches 1 run bossbar set boogeyreveal visible false