...
execute if score lastlife constants matches 1.. as @a[scores={death=1..,lives=1..}] on attacker if entity @s[tag=boogeyman] run tellraw @a [{"selector":"@s"},{"text":" was cured.", "color":"green"}]
execute if score lastlife constants matches 1.. as @a[scores={death=1..,lives=1..}] on attacker if entity @s[tag=boogeyman] run tag @s remove boogeyman
execute if score limitedlife constants matches 1.. as @a[scores={death=1..}] on attacker if entity @s[tag=boogeyman] run tellraw @a [{"selector":"@s"},{"text":" was cured.", "color":"green"}]
execute if score limitedlife constants matches 1.. as @a[scores={death=1..}] on attacker if entity @s[tag=boogeyman] run tag @s remove boogeyman
