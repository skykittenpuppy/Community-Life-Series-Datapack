execute if score limitedlife constants matches 1.. as @a[scores={death=1..}] on attacker if entity @s[tag=!boogeyman] run scoreboard players add @s time 36000
execute if score limitedlife constants matches 1.. as @a[scores={death=1..}] on attacker if entity @s[tag=boogeyman] run scoreboard players add @s time 72000
execute if score limitedlife constants matches 1.. as @a[scores={death=1..}] on attacker if entity @s[tag=boogeyman] run scoreboard players remove @a[scores={death=1..}] time 72000

execute as @a[scores={death=1..}] on attacker if entity @s[tag=boogeyman] run tellraw @a [{"selector":"@s"},{"text":" was cured.", "color":"green"}]
execute as @a[scores={death=1..}] on attacker if entity @s[tag=boogeyman] run tag remove @s boogeyman
